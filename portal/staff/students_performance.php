		...
		<div class="row">
			...
			<div class="panel panel-default">
					...
					if(isset($_POST["view"])){
						...
						if($num ==0){
							...
							echo "<table class='table table-bordered'>
									...
									<form method='POST' action = 'students_performance.php'><input type='hidden' name='adno' 
									value='$admission_no' >
									<p class='text-center'><button type='submit' name='result' class='btn btn-primary'>View result</button></form></p>
							";
						}
					}
				...
				<tr>
						...
						<?php
						$adno = $_POST['adno'];
						$run2 = mysqli_query($con,"SELECT * FROM result where student = '$adno' ");
